...
class TestRead(unittest.TestCase):
    ...
    def test_goslim_from_file(self):
        G = goenrich.obo.ontology(pkg_file(__name__, 'test_ontologies/goslim_generic.obo'))
        self.assertEqual(len(G.nodes()), 149)
        self.assertSetEqual(set(G.successors('GO:0009056')), set(['GO:0008150']))
        self.assertSetEqual(set(G.predecessors('GO:0009056')),
                            set(['GO:0034655', 'GO:0006914']))
